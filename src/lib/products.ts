...
const productSeed: Product[] = [
  ...
  { id: 87, slug: "ai-course", name: "AI Course", category: "Learning", price: 200000, image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&w=1200&q=80", badge: "Course", tags: ["AI", "Prompting", "Automation", "Learning"], description: "A practical one-month AI course for using modern AI tools to work faster, create content, analyze information, and automate daily tasks. Price is RWF 200,000 per month." },
];
